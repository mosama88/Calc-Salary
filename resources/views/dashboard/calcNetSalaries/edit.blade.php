...
@section('page-header', 'تعديل عملة جديده')
@section('page-header_desc', 'تعديل عملة جديده')
@section('page-header_link')
    <li class="breadcrumb-item"><a href="{{ route('dashboard.calcNetSalary.index') }}">جدول العملات</a></li>
@endsection
@section('content')
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">تعديل بيانات المرتب</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
